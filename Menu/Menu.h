...
public:
	...
	struct
	{
		...
		zgui::color WeaponChamsColor = { 255,255,255,255 }; // why it right here LOL
		int GlowAlpha;
		int ChamsMaterial;
		int KnifeModel;
		bool Name;
		...
		zgui::color ChickenChamsColor{ 255, 255, 255, 255 };
	...
	struct {
		bool legitbot, ragebot, visual, misc, config, exploits, debug;
		int Config;
	}Tabs;
