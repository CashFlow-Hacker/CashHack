...
/*int OnDllAttach()
{
	...
	string x = client.Get(("put site here")); // if u actually wanna use my "hwid" bullshit, u can use this right here by replacing the site with ur site. i stored my hwids in a text file on my site btw
