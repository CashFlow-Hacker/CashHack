...
public:
	...
	{
		Utils::GetVFunc<void(__thiscall*)(void*)>(this, 222)(this);
	}
	...
	{
		typedef float(__thiscall * WeaponIndex)(PVOID);
		return Utils::GetVFunc< WeaponIndex >(this, 447)(this);
	}
    ...
    Vector GetEyePosition() 
	{
		...
		Utils::GetVFunc<OrigFn>(this, 282)(this, ret);
		return ret;
	}
...
public:
	...
	float GetInaccuracy()
	{
		...
		return Utils::GetVFunc< oInaccuracy >(this, 477)(this); //471
	}

	float GetSpread()
	{
		typedef float(__thiscall* oWeaponSpread)(PVOID);
		return Utils::GetVFunc< oWeaponSpread >(this, 447)(this); //439
	}
    ...
    {
        return Utils::CallVFunc<455, WeaponInfo_t*>(this);
    }
